const YogaSubscription = () => {
    return (
        <div className="max-w-7xl mx-auto p-8 bg-rose-400 rounded-3xl text-white">
            <div className="flex flex-col lg:flex-row justify-between space-y-6 lg:space-y-0 lg:space-x-8">
                ...
                <div className="bg-white rounded-xl p-4 text-black shadow-lg w-full lg:w-72">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-2 bg-rose-100 rounded-lg">
                            <div>
                                <input type="radio" id="monthly" name="subscription" className="mr-2" />
                        ...
                        <div className="flex items-center justify-between p-2 bg-rose-100 rounded-lg">
                            <div>
                                <input type="radio" id="yearly" name="subscription" className="mr-2" />
